...
// Planning Constants
#define P_NUM_PATHS 7                  // TODO - Num of paths (goals) 1->7
...
#define P_MAX_ACCEL 3.0                // m/s^2   1.5->3.0
#define P_SLOW_SPEED 1.0               // m/s
#define P_SPEED_LIMIT 6.0              // m/s  3.0->6.0
#define P_STOP_LINE_BUFFER 2.5         // m    0.5->2.5
#define P_STOP_THRESHOLD_SPEED 0.02    // m/s
#define P_REQ_STOPPED_TIME 3.0         // secs  1.0->3.0
