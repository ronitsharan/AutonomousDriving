...
data_filename = 'training_segment-1005081002024129653_5313_150_5333_150_with_camera_labels.tfrecord' # Sequence 1 S2_EX1
# data_filename = 'training_segment-10072231702153043603_5725_000_5745_000_with_camera_labels.tfrecord' # Sequence 2
#data_filename = 'training_segment-10963653239323173269_1924_000_1944_000_with_camera_labels.tfrecord' # Sequence 3 S1_EX2
# show_only_frames = [0, 200] # show only frames in interval for debugging
#show_only_frames = [0, 1] #S1_EX1, S2_EX1, S2_EX3
#show_only_frames = [0, 200] #S1_EX2
show_only_frames = [50, 51] #S3_EX1
...
#configs_det = det.load_configs(model_name='fpn_resnet') #S3_EX1
...
#exec_data = [] #S1_EX1, S1_EX2
exec_data = ['pcl_from_rangeimage'] #S2_EX1, S2_EX2, S2_EX3, S4_EX1-3
#exec_data = ['pcl_from_rangeimage','load_image'] #S3_EX1
...
#exec_detection = [] # S1_EX1, S1_EX2
#exec_detec#tion = ['bev_from_pcl'] #S2_EX1, S2_EX2, S2_EX3
exec_detection = ['bev_from_pcl','detect_objects', 'validate_object_labels', 'measure_detection_performance'] #S3_EX1
exec_tracking = [] # options are 'perform_tracking' S2_EX1#exec_visualization = ['show_range_image'] # S1_EX1
#exec_visualization = ['show_range_image'] #S1_EX1
#exec_visualization = ['show_pcl'] # S1_EX2
#exec_visualization = [] # S2_EX1, S2_EX2, S2 EX_3
#exec_visualization = ['show_objects_in_bev_labels_in_camera'] # S3_EX1
exec_visualization = ['show_detection_performance'] #S4_EX3
